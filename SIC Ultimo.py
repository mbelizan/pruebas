    ...
    MDBoxLayout:
		...
		FloatLayout:
            ...
            MDLabel:
                id:TituloNC1
                markup: True
                text: "[color=#315582]Nuevo Cliente[/color]"
                pos_hint: {"center_x": .93, "center_y": .75}
                font_size: 30
            ...
            MDLabel:
                ...
                markup: True
                text: "Nombre"
                pos_hint: {"center_x": .51, "center_y": .65}
                font_size: 16

            MDTextField:
                id: InputNombreNC1
                pos_hint: {"center_x": .145, "center_y": .60}
                size_hint: None, None
                width: 350
            ...
            MDTextField:
                id: InputApellidoNC1
                pos_hint: {"center_x": .145, "center_y": .50}
                size_hint: None, None
                width: 350
            ...
            MDTextField:
                id: InputDNINC1
                pos_hint: {"center_x": .145, "center_y": .40}
                size_hint: None, None
                width: 350
            ...
            MDTextField:
                ...
                pos_hint: {"center_x": .145, "center_y": .30}
                size_hint: None, None
                width: 350
            ...
            MDTextField:
                id: InputTelefonoNC1
                pos_hint: {"center_x": .145, "center_y": .20}
                size_hint: None, None
                width: 350
            ...
            MDLabel:
                ...
                markup: True
                text: "Email"
                pos_hint: {"center_x": .51, "center_y": .15}
                font_size: 16

            MDTextField:
                id: InputEmailNC1
                pos_hint: {"center_x": .145, "center_y": .10}
                size_hint: None, None
                width: 350
    ...
    MDBoxLayout:
		...
		FloatLayout:
            ...
            MDLabel:
                ...
                pos_hint: {"center_x": .97, "center_y": .75}
                font_size: 30
    ...
    MDBoxLayout:
		...
		FloatLayout:
            ...
            MDLabel:
                id:TituloEC1
                markup: True
                text: "[color=#315582]Editar Cliente[/color]"
